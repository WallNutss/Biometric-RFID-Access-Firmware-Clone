...
#define LAST_BUILD_FIRMWARE_VERSION 0.0.4;
#define LAST_FIRMWARE_VERSION_FILENAME 0_0_4;
#define LAST_COMMIT_HASH 54703cb;
#define LAST_BUILD_TIMESTAMP 2025-Mar-21-20:02:08;
